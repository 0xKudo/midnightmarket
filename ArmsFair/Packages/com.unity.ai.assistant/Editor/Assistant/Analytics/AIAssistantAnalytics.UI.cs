...
namespace Unity.AI.Assistant.Editor.Analytics
{
    ...
    internal static partial class AIAssistantAnalytics
    {
        ...
        {
            ReportUITriggerLocalEvent(new UITriggerLocalEventData(UITriggerLocalEventSubType.GenerateContent)
            {
        ...
        {
            ReportUITriggerLocalEvent(new UITriggerLocalEventData(UITriggerLocalEventSubType.ChangeGeneratorMode)
            {
