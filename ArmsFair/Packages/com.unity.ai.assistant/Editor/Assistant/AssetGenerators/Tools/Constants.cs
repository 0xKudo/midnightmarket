...
namespace Unity.AI.Assistant.Editor.Backend.Socket.Tools
{
    static class Constants
    {
        ...
        public const string ReferenceImageInstanceIdsDescription = "An array of instance IDs of EXISTING images (Texture2D) that will be used as reference images for generation. " +
